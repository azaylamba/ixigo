...
You have to design & build the backend for the application and the ability for the users to register, find buses and book tickets.
...
https://github.com/azaylamba/ixigo 
